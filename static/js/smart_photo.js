var SmartPhoto = (function () {
    ...
    // a class w/ prototype to create a new SmartPhoto instance.
    var __SmartPhoto = function (el) {
        var self = this;
        ...
        if (el instanceof Node) {
            ...
            blueslip.warn("Error. 'SmartPhoto' accepts either string selector or node.");
            return;
        }
    ...
    __SmartPhoto.prototype = {
        // set the speed at which scrolling zooms in on a photo.
        speed: function (speed) {
            this.meta.speed = speed;
        },

        // set the max zoom of the SmartPhoto canvas as a mult of the total width.
