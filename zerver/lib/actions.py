...
def get_realm_creation_defaults(org_type=None, restricted_to_domain=None, invite_required=None):
    # type: (Optional[text_type], Optional[bool], Optional[bool]) -> Dict[text_type, Any]
    if org_type is None:
...
def do_create_realm(domain, name, restricted_to_domain=None, invite_required=None, org_type=None):
    # type: (text_type, text_type, Optional[bool], Optional[bool], Optional[text_type]) -> Tuple[Realm, bool]
    ...
    if created:
        ...
        realm = Realm(domain=domain, name=name, org_type=org_type,
